<?php
	...
	include_once "modals/functions.php";
		...
		<main id="shop">
			...
			<div class="col-12 input-group rounded tm-welcome-section">
				...
				<span class="input-group-text border-0" id="search-addon">
					<a href="cart.php#cart" class="text-dark"><i class="fa fa-shopping-cart tm-social-icon" aria-hidden="true"><span id="countCart">0</span></i></a>							
				</span>
			  </div>
			<div class="row  tm-welcome-section">
				...
				?>
					<div class="form-check form-check-inline">
						<input class="cat" name="cat" type="checkbox" id="inlineCheckbox1" value="<?=$categorie->id_cat?>">
			...
			<div class="row tm-gallery">
				...
				?>
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="img/gallery/<?=$product->picture_src?>" alt="<?=$product->name_products?>" class="img-fluid tm-gallery-img" />
							<figcaption>
