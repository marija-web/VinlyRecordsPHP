$(document).ready(function(){
    ...
    ajaxCallBAck("modals/pagination.php", "post", {
        valuePag:0
    }, function(result){
    ...
    //funkcija za toggle
     ...
     function filterCat(){
         ...
         ajaxCallBAck("modals/filterCat.php", "post", valueToSend, function(result){
     ...
     function clickSurvey(){
         ...
         ajaxCallBAck("modals/survey.php", "post", surveyInfo, function(result){
           alert(result);
     ...
     $(document).on('click', '.clickPag', function(e){
        ...
        ajaxCallBAck("modals/pagination.php", "post", valuePag, function(result){
            writeProductsPag(result.products);
     ...
     function writeProductsPag(arrayP){
         ...
         if(arrayP.length==0){
            ...
            for(var obj2 of arrayP){
                ...
                <figure>
                    <img src="img/gallery/${obj2.picture_src}" alt="${obj2.name_products}" class="img-fluid tm-gallery-img" />
                    <figcaption>
    ...
    if(document.URL.includes("cart.php")){
                ...
                <tr>
                    <td data-th="Product">
                            <div class="col-sm-2 hidden-xs mr-5" >
                                <img src="img/gallery/${obj7.picture_src}" alt="${obj7.name_products}" class="img-responsive"/>
                            </div>
                            <div class="col-sm-5">
        ...
        function alertFinish(e){
            ...
            if(cartItems.length!=0){
                ...
                ajaxCallBAck("modals/insertCart.php", "post", data, function(result){
                alert(result);
    ...
    if(document.URL.includes("messagesSurvey.php")){
    ...
    //anketa
    ajaxCallBAck("modals/getActivNoActiv.php", "get", {button:true}, function(result){
        var valueC;
    ...
    $(document).on("click", ".activ", function(){
        ...
        ajaxCallBAck("modals/activeSurvey.php", "post", dataToSendA, function(result){
            alert(result);
        });
     })
    ...
    //funckija za artist(delete, insert, update)
     if(document.URL.includes("artistTable.php")){
        //delete artist
        $(document).on("click", ".deleteArtist", function(e){
            ...
            ajaxCallBAck("modals/deleteArtist.php", "post", dataToSendA, function(result){
                writeArtist(result);
            });
        })
        ...
        $(document).on("click", ".updateArtist", function(e){
            ...
            ajaxCallBAck("modals/updateArtist.php", "post", dataToSendA, function(result){
                writeArtist(result);
              });
        })
        //insert category
        ...
        ajaxCallBAck("modals/insertArtist.php", "post", dataToSendA, function(result){
            alert(result);
            location.reload();
        });
    ...
    if(document.URL.includes("priceTable.php")){
        ...
        $(document).on("click", ".updatePrice", function(e){
            ...
            ajaxCallBAck("modals/updatePrice.php", "post", dataToSendP, function(result){
                alert(result);
            });
        })
    }
    ...
    if(document.URL.includes("usersTable.php")){
        ...
        function writeUsers(arrayUsers){
            ...
            for(var obj13 of arrayUsers){
                html13+=` <th scope="row">${obj13.id_user}</th>
